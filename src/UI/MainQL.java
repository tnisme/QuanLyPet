...
public class MainQL extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btn_import_statistical1 = new javax.swing.JPanel();
        ...
        btn_import_statisticalLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, btn_import_statisticalLayout.createSequentialGroup()
        ...
        btn_import_statistical1.setBackground(new java.awt.Color(255, 255, 255));
        btn_import_statistical1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btn_import_statistical1btn_sold_statisticalMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                btn_import_statistical1btn_sold_statisticalMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                btn_import_statistical1btn_sold_statisticalMouseExited(evt);
            }
        });
        ...
        javax.swing.GroupLayout btn_import_statistical1Layout = new javax.swing.GroupLayout(btn_import_statistical1);
        btn_import_statistical1.setLayout(btn_import_statistical1Layout);
        btn_import_statistical1Layout.setHorizontalGroup(
            btn_import_statistical1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 90, Short.MAX_VALUE)
            .addGroup(btn_import_statistical1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(btn_import_statistical1Layout.createSequentialGroup()
                    .addGap(0, 0, Short.MAX_VALUE)
                    .addComponent(jLabel43)
                    .addGap(0, 0, Short.MAX_VALUE)))
        );
        btn_import_statistical1Layout.setVerticalGroup(
            btn_import_statistical1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 30, Short.MAX_VALUE)
            .addGroup(btn_import_statistical1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(btn_import_statistical1Layout.createSequentialGroup()
        ...
        panel_header_statistical.add(btn_import_statistical1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 60, 90, 30));
        ...
        statistical_chart_revenue.setBackground(new java.awt.Color(255, 255, 255));
    ...
    private void btn_sold_statisticalMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_sold_statisticalMouseEntered
        ...
        if (evt.getSource() == btn_import_statistical1) {
            btn_import_statistical1.setBackground(new Color(110, 89, 222));
        }
    ...
    private void btn_sold_statisticalMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_sold_statisticalMouseExited
        ...
        if (evt.getSource() == btn_import_statistical1) {
            btn_import_statistical1.setBackground(new Color(255, 255, 255));
        }
    ...
    private void btn_sold_statisticalMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_sold_statisticalMouseClicked
        ...
        if (evt.getSource() == btn_import_statistical1) {
            statistical_chart_sold.setVisible(false);
            statistical_chart_import.setVisible(false);
            statistical_chart_revenue.setVisible(true);
        }
    ...
    private void btn_import_statistical1btn_sold_statisticalMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_import_statistical1btn_sold_statisticalMouseClicked
        // TODO add your handling code here:
        statistical_chart_sold.setVisible(false);
        statistical_chart_import.setVisible(false);
        statistical_chart_revenue.setVisible(true);
    }//GEN-LAST:event_btn_import_statistical1btn_sold_statisticalMouseClicked

    private void btn_import_statistical1btn_sold_statisticalMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_import_statistical1btn_sold_statisticalMouseEntered
        // TODO add your handling code here:
        btn_import_statistical1.setBackground(new Color(110, 89, 222));
    }//GEN-LAST:event_btn_import_statistical1btn_sold_statisticalMouseEntered

    private void btn_import_statistical1btn_sold_statisticalMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_import_statistical1btn_sold_statisticalMouseExited
        // TODO add your handling code here:
        btn_import_statistical1.setBackground(new Color(255, 255, 255));
    }//GEN-LAST:event_btn_import_statistical1btn_sold_statisticalMouseExited
    ...
    private javax.swing.JPanel btn_import_statistical1;
